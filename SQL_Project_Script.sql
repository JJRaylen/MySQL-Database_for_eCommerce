...
CREATE TABLE IF NOT EXISTS `Project03`.`Seller` (
  ...
  `seller_visible_date` DATETIME NOT NULL,
  ...
  `Transaction_Shop_Cart_Info_Items_Item_ID` VARCHAR(14) NOT NULL,
  `Transaction_Buyer_Buyer_ID` VARCHAR(14) NOT NULL,
  PRIMARY KEY (`Seller_short_code`, `Transaction_Trans_ID`, `Transaction_Shop_Cart_Info_Shop_cart_ID`, `Transaction_Shop_Cart_Info_Items_Item_ID`, `Transaction_Buyer_Buyer_ID`),
